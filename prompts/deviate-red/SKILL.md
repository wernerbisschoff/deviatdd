...
**IMPORTANT**: The script `deviate-red.sh` lives in this skill's directory (alongside `SKILL.md`) and is NOT on `PATH`. Always invoke it as `<SKILL_DIR>/deviate-red.sh`.
