...
- [x] TSK-001-01: Profile Module + ProfileConfig TOML Section
  - **Type**: Feature_Batch
  - **Mode**: TDD
...
- [x] TSK-001-02: @with_json_quiet Decorator + Pre-Subcommand Wiring
  - **Type**: Feature_Batch
  - **Mode**: TDD
  - **Test Strategy**: Sociable_Unit
...
- [x] TSK-001-05: Pytest JSON Report Support
  - **Type**: Feature_Batch
  - **Mode**: TDD
  - **Test Strategy**: Sociable_Unit
