...
- **Tamper Guard**: GREEN phase resets test directories to post-RED commit state before evaluation. Unauthorized writes outside implementation targets trigger rollback.
