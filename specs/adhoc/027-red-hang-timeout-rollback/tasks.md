...
- TSK-027-03: Document RED `AGENT_TIMEOUT` and dirty-tree rollback
  - **Type**: Config
  - **Mode**: IMMEDIATE
  - **Verification**: `uv run pytest tests/test_core/test_agent.py tests/test_cli/test_micro.py tests/test_micro/test_e2e.py -q -k "timeout or stall or find_task_record or already_done or red"`
